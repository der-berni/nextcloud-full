...
[![docker-build-push](https://github.com/der-berni/nextcloud-full/actions/workflows/main.yml/badge.svg)](https://github.com/der-berni/nextcloud-full/actions/workflows/main.yml)


The `full` Dockerfile adds dependencies for all optional packages suggested by nextcloud that may be needed for some features (e.g. Video Preview Generation), as stated in the [Administration Manual](https://docs.nextcloud.com/server/latest/admin_manual/installation/source_installation.html).
...
Removed Module:
- imagick (already in upstream)
- imap (The libc-client-dev package is no longer available in Debian Trixie, as it has been unbundled from PHP and is not provided in the official repositories.)
- gmp (already in upstream)
